    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'ADR-003 Preset 是代码', link: '/decisions/ADR-003-preset-as-code' },
          { text: 'ADR-004 Policy 严重级别', link: '/decisions/ADR-004-policy-severity-rules' },
          { text: 'ADR-005 语义治理调度', link: '/decisions/ADR-005-semantic-governance' },
          { text: 'ADR-006 Run 生命周期', link: '/decisions/ADR-006-run-lifecycle' },
          { text: 'ADR-007 规则种类与约束', link: '/decisions/ADR-007-rule-kinds-and-constraints' },
